...
Predicted tasks for this iteration of the project.
...
<table>
  ...
  <tbody>
    <tr style={{backgroundColor: '#e3f2fd', borderBottom: '1px solid #999', color: '#000'}}>
    ...
    <tr style={{backgroundColor: '#e3f2fd', borderBottom: '2px solid #333', color: '#000'}}>
    ...
    <tr style={{backgroundColor: '#e1f5e1', borderBottom: '1px solid #999', color: '#000'}}>
    ...
    <tr style={{backgroundColor: '#e1f5e1', color: '#000'}}>
      <td align="center" style={{borderRight: '1px solid #999'}}>7/11/2025 → 15/11/2025</td>
      <td>Architecture</td>
    </tr>
    <tr style={{backgroundColor: '#e1f5e1', borderBottom: '2px solid #333', borderRight: '1px solid #999', color: '#000'}}>
    ...
    <tr style={{backgroundColor: '#fff9e1', borderBottom: '1px solid #999', color: '#000'}}>
    ...
    <tr style={{backgroundColor: '#fff9e1', borderBottom: '1px solid #999', color: '#000'}}>
      ...
      <td>&nbsp;&nbsp;• Base MLOps pipeline</td>
    </tr>
    <tr style={{backgroundColor: '#fff9e1', color: '#000'}}>
        <td align="center" style={{borderRight: '1px solid #999'}}>2/12/2025 → 14/12/2025</td>
      <td>&nbsp;&nbsp;• Basic UI Dashboard</td>
    </tr>
    <tr style={{backgroundColor: '#fff9e1', borderBottom: '2px dashed #333', color: '#000'}}>
    ...
    <tr style={{backgroundColor: '#ffe8d6', borderBottom: '1px solid #999', color: '#000'}}>
    ...
    <tr style={{backgroundColor: '#ffe8d6', borderBottom: '2px dashed #333', color: '#000'}}>
      <td>Decision assessment &amp; Enforcement</td>
    </tr>
    <tr style={{backgroundColor: '#ffd4b8', borderBottom: '1px solid #999', color: '#000'}}>
